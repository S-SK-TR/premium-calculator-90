...
- `CLAUDE.md` dosyasındaki `Calculator - Premium Hesap Makinesi`, `Calculator - Premium Hesap Makinesi — Premium SaaS Uygulaması`, `[TECH_STACK]` gibi alanları gerçek değerlerle değiştir
